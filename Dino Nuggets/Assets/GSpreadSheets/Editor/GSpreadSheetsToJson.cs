...
public class GSpreadSheetsToJson : EditorWindow
{
    ...
    /// </summary>
    [SerializeField]
    private string spreadSheetKey = "1vxVP-NHeedfrJCdAf4VPfugO53SkfmZzci441kFGmck";

    /// <summary>
    /// List of sheet names which want to download and convert to json file
    /// </summary>
    [SerializeField]
    List<string> wantedSheetNames = new List<string>();
    ...
    /// </summary>
    public string outputDir = "Assets/Resources/Data/";
